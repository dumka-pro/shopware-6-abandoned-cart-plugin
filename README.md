...
| 6.5              | 3.0.5          | [🔗 View Release](https://github.com/mailcampaigns/shopware-6-abandoned-cart-plugin/releases/tag/3.0.5) |
| 6.6              | 3.0.5          | [🔗 View Release](https://github.com/mailcampaigns/shopware-6-abandoned-cart-plugin/releases/tag/3.0.5) |

> ✅ Note: Plugin version `3.0.5` supports both Shopware `6.5` and `6.6`.
